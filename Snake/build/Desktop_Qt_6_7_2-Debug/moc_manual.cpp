...
struct qt_meta_stringdata_CLASSmanualENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSmanualENDCLASS = QtMocHelpers::stringData(
    "manual",
    "paintEvent",
    "",
    "QPaintEvent*",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSmanualENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject manual::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CLASSmanualENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSmanualENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSmanualENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<manual, std::true_type>,
        // method 'paintEvent'
...
void *manual::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSmanualENDCLASS.stringdata0))
